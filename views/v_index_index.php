...
<div id="newGame">
	...
	<input type="button" class="difficultySelect" id="easy" value="Easy" />
	<input type="button" class="difficultySelect" id="medium" value="Medium" />
	<input type="button" class="difficultySelect" id="hard" value="Hard" />
	<input type="button" class="difficultySelect" id="vhard" value="Run Away Screaming" />
</div>